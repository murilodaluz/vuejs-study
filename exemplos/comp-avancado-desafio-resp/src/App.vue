<template>
	<div id="app">
		<span>
			<!-- Cara botão altera o valor da variavel componente contendo o nome do componente que sera carregado -->
		...
		<!-- Sera carregado dinamicamente os componentes -->
		<component :is="componente">
			<!-- slot nomeado como conteudo, que em cada componente filho contem uma tag slot nomeada onde sera carregado o conteudo -->
